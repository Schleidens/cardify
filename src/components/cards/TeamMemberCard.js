  ...
  return (
    <div className="rounded border-solid border-2 border-gray-100 p-4">
      <div className="mb-4 flex flex-col items-center">
        ...
        <h2 className="text-base text-gray-400">Front-end Developer</h2>
      </div>
      ...
      <div className="flex justify-center border-solid border-0 border-t border-gray-200 pt-4">
        <a className="mx-1 rounded-full border border-gray-200 p-2">
          <svg
...
export default function TeamMemberCard() {
  ...
  return (
    <div className="reset mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-2">
      {times.map((index) => (
        <TeamMemberCardComponent key={index} />
      ))}
    </div>
  );
}
